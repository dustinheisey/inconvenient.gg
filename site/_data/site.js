  ...
  navigation: {
    ...
    bottombar: {
      links: [
        ...
        { label: 'Learn', url: '/learn', icon: 'books' },
  ...
  pages: [
    ...
    },
    {
      ...
      regions: {
        intro: {
          layout: 'end-heavy',
          end: { component: 'img', src: 'making-a-difference.png', alt: 'Making a Difference' },
          start: {
            size: 'page',
            component: 'text',
            overline: 'Our Impact',
        ...
        stories: {
          layout: 'end-heavy',
          style: { inset: true },
          start: { component: 'img', style: { ar: 'avatar-img' }, src: 'jessica.jpeg', alt: 'Jessica' },
          end: {
        ...
        action: {
          layout: 'split',
          theme: 'dark',
          start: { component: 'img', src: 'how-you-can-help.png', alt: 'How You Can Help' },
          end: {
            component: 'text',
      ...
      regions: {
        ...
        gallery: {
          ...
          items: [
            {
              component: 'card',
              style: { theme: 'primary-container', span: 2 },
              overline: 'Education',
            ...
            {
              component: 'card',
              style: { theme: 'secondary-container', span: 2 },
              overline: 'Research',
        ...
        partnerships: {
          layout: 'split',
          theme: 'dark',
          start: { component: 'img', src: 'become-a-partner.png', alt: 'Become a Partner' },
          end: {
            component: 'text',
    ...
    },
    {
      ...
      regions: {
        intro: {
          layout: 'end-heavy',
          end: { component: 'img', src: 'collaboration.png', alt: 'Collaboration' },
          start: {
            size: 'page',
            component: 'text',
        ...
        partners: {
          ...
          items: [
            ...
            { component: 'blurb', headline: 'City Roots', img: { src: 'cityroots-logo.png', alt: 'City Roots' } },
            { component: 'blurb', headline: 'Desert Bloom', img: { src: 'desertbloom-logo.png', alt: 'Desert Bloom' } }
          ]
        },
        action: {
          layout: 'split',
          theme: 'dark',
          start: { component: 'img', src: 'lush-bee-habitat.png', alt: 'Lush Bee Habitat' },
          end: {
            component: 'text',
        ...
        form: {
          ...
          start: {
            ...
            inputs: [
              ...
              { required: true, label: 'Message', id: 'message', type: 'textarea' }
            ],
            submit: 'Connect'
          }
        }
    ...
    },
    {
      ...
      regions: {
        intro: {
          layout: 'end-heavy',
          end: { component: 'img', src: 'positive.png', alt: 'Positive Impact' },
          start: {
            size: 'page',
            component: 'text',
            overline: 'Donate',
    ...
    },
    {
      ...
      regions: {
        intro: {
          layout: 'split',
          theme: 'dark',
          start: { component: 'img', src: 'get-involved.png', alt: 'Get Involved' },
          end: {
            component: 'text',
            get navbar() {
              return config.navigation
